...
# New research task with specifying the country name 
research_task = Task(
    description="""Conduct a comprehensive analysis of potential retail property investments in **China**.

    Specific research requirements:
    1. Market Analysis:
       - Identify top 3-5 potential retail property investment locations in China
       - Analyze current market trends and economic indicators
       - Assess demographic data and consumer spending patterns
       - Evaluate local retail ecosystem and potential tenant mix
    ...
    Deliverable: A comprehensive, data-driven investment recommendation report focused on China.""",
    agent=property_researcher,
    expected_output="""Detailed report containing:
    - Market analysis summary for China
    - Top 3-5 recommended retail property investments in China
    - Comprehensive financial projections
    - Risk assessment
    - Recommendations for further due diligence""",
    output_file="research_task_output_internet.txt"
...
old_research_task = Task(
    description="""Search the internet and find 5 promising real estate investment cities in China. 
